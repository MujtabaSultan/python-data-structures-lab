...
def manage_students():
    student = ["ali","nohaiz","mueen"]
    first_student= student[1]
    second_student= student[2]
...
home_town = {
    "city": "canada",
    "state": "mars",
    "population": 121313081301381301
}
def hometown_info():
  
    home_town_message = f"i was botn in {home_town['city']}, {home_town['state']} and it has a population of {home_town['population']}"
